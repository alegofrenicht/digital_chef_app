...
const showRecipe = async function () {
  try {
    const res = await fetch('https://api.spoonacular.com/recipes/654959/information?apiKey=d754bd859d5c40abaf88e8715002bd21');
    ...
    const markup = `
        ...
        <div class="recipe__directions">
          ...
          <p class="recipe__directions-text">
            ...
            <span class="recipe__publisher">${data.creditsText}</span>. Please check out
