...
class RecipeView {
    ...
    #data;
    #errorMessage = "Oops! We couldn't find such recipe. Please try again or contact our support";
    #successMessage = "";
    ...
    addHandlerRender(handler){
        Array(['hashchange', 'load']).forEach(ev => window.addEventListener(ev, handler));  
    };
